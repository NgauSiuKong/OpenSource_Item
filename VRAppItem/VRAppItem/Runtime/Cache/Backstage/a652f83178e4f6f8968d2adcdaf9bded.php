...
<body>
<div class="pd-20">
	<form action="/VRAppItem/index.php/Backstage/Facility/editModel" method="post" class="form form-horizontal" id="form-article-add">
        <input type="hidden" value="<?php echo ($faci_info['id']); ?>" name="id"/>
        <input type="hidden" value="<?php echo ($fid); ?>" name="fid"/>
		<div class="row cl">
			<label class="form-label col-2">设备名：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="<?php echo ($faci_info['facilityname']); ?>" id="imageatitle" name="facilityname">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">设备备注：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="<?php echo ($faci_info['remark']); ?>" id="imageadescribe" name="remark">
			</div>
		</div>
		<div class="row cl">
