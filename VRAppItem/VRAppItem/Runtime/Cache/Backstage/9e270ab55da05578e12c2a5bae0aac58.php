...
<div class="pd-20">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="/VRAppItem/index.php/Backstage/Lable/add"class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加分类</a></span> <span class="r">共有数据：<strong><?php echo ($list['count']); ?></strong> 条</span> </div>
	...
	<table class="table table-border table-bordered table-bg">
		<thead>
			...
			<tr class="text-c">
				...
				<th><i class="Hui-iconfont">&#xe69d;&#xe69d;</i>分类名<i class="Hui-iconfont">&#xe69d;&#xe69d;</i></th>
				<th>分类描述</th>
				<th>加入时间</th>
				<th>排序</th>
				<th>状态</th>
		...
		<tbody>
            <?php if(is_array($list['selArr'])): $i = 0; $__LIST__ = $list['selArr'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr class="text-c">
				...
				<td>
                    <i class="Hui-iconfont"><a href="/VRAppItem/index.php/Backstage/Lable/classSort?handle=pre&id=<?php echo ($val["id"]); ?>&oid=<?php echo ($val["oid"]); ?>">&#xe679;</a></i>
                    <i class="Hui-iconfont"><a href="/VRAppItem/index.php/Backstage/Lable/classSort?handle=next&id=<?php echo ($val["id"]); ?>&oid=<?php echo ($val["oid"]); ?>">&#xe674;</a></i>
                </td>
                <td class="td-status">
...
function admin_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		//此处请求后台程序，下方是成功后的前台处理……
		 $.ajax({ 
                url:'/VRAppItem/index.php/Backstage/Lable/delete',
                type:'post',
                dataType:'json',
                data:{id:id},
...
function admin_stop(obj,id){
	layer.confirm('确认要停用吗？',function(index){
		//此处请求后台程序，下方是成功后的前台处理……
		$.ajax({ 
                url:'/VRAppItem/index.php/Backstage/Lable/status',
                type:'post',
                dataType:'json',
                data:{id:id},
                success:function(msg){ 
