...
<body>
<div class="pd-20">
	<form action="/VRAppItem/index.php/Backstage/Panorama/panoramaAdd" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
		<div class="row cl">
			<label class="form-label col-2">图片标题：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="" placeholder="请输入图片标题" id="imageatitle" name="name">
			</div>
		</div>
        <div class="row cl">
            <label class="form-label col-2">图片副标题：</label>
            <div class="formControls col-10">
                <input type="text" class="input-text" value="" placeholder="请输入图片标题" id="imageatitle" name="subname">
            </div>
        </div>
		<div class="row cl">
        ...
        <div class="row cl">
            <label class="form-label col-2">图片类型：</label>
                <input type="radio"  value="0" id="sellinkurl" name="limit" checked>普通图片
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio"  value="1" id="sellinkvideo" name="limit">会员图片
        </div>
         <div class="row cl">
           <label class="form-label col-2">点击上传视频详情图</label>
            ...
            <div class="uploader-thum-container">
                <div id="preview">
                     <img id="imghead" width=100% height=auto border=0 src='/VRAppItem/Public/Backstage/images/no_upload_big.jpg'>
                </div>
