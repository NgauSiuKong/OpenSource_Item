...
<body>
<div class="pd-20">
	<form action="/VRAppItem/index.php/Backstage/Video/editVideo" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
        <input type="hidden" name="v_id" value="<?php echo ($video_info['v_id']); ?>"/>
		<div class="row cl">
			<label class="form-label col-2">资源标题</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="<?php echo ($video_info['v_title']); ?>" id="imageatitle" name="v_title">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">资源描述</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="<?php echo ($video_info['v_describe']); ?>" id="imageadescribe" name="v_describe"> 
			</div>
		</div>
        <div class="row cl">
            <label class="form-label col-2">资源限制</label>
           
                <input type="radio"  value="0"  name="limit" <?php if($video_info['limit'] == 0 ): ?>checked<?php endif; ?>>普通资源
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio"  value="1"  name="limit" <?php if($video_info['limit'] == 1 ): ?>checked<?php endif; ?>>会员资源

        </div>
        <div class="row cl">
            <label class="form-label col-2">来源类型</label>
                <input type="radio"  value="0" id="sellinkvideo" name="v_type" <?php if($video_info['v_type'] == 0 ): ?>checked<?php endif; ?>>链接视频
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio"  value="1" id="sellinkurl" name="v_type" <?php if($video_info['v_type'] == 1 ): ?>checked<?php endif; ?>>上传视频
        </div>
        <div id="video">
            <div class="row cl">
        ...
        <div id="link">
            <div class="row cl">
            <label class="form-label col-2">填写视频链接</label>
            <div class="formControls col-10">
                <input type="text" class="input-text" value="<?php echo ($video_info['v_data']); ?>" id="linkurl" name="v_data">
            </div>
            </div>
        </div>
        <div id="link">
            <div class="row cl">
            <label class="form-label col-2">视频播放量修改</label>
            <div class="formControls col-10">
                <input type="text" class="input-text" value="<?php echo ($video_info['playnum']); ?>" id="linkurl" name="playnum">
            </div>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="uploader-thum-container">
                <div id="preview_small">
                    <img id="imghead_small" width=100% height=auto border=0 src="/VRAppItem/Public/<?php echo ($video_info['v_firstimgurl']); ?>">
                </div>
        ...
        <div class="row cl">
           <label class="form-label col-2">点击上传视频详情图</label>
            ...
            <div class="uploader-thum-container">
                <div id="preview_big">
                    <img id="imghead_big" width=100% height=auto border=0 src="/VRAppItem/Public/<?php echo ($video_info['v_secondimgurl']); ?>">
                </div>
            ...
            <div class="formControls col-5"> 
                <select size="1" name="v_cid">
                    ...
                    <?php if(is_array($classlist)): foreach($classlist as $key=>$val): ?><option disabled="disabled">--<?php echo ($val["c_title"]); ?>--</option>
                        <?php if(is_array($val['son'])): foreach($val['son'] as $key=>$v): ?><option value="<?php echo ($v["c_id"]); ?>" <?php if($video_info['v_cid'] == $v['c_id']): ?>selected<?php endif; ?>>--|--<?php echo ($v["c_title"]); ?>--</option><?php endforeach; endif; endforeach; endif; ?>
                </select>
            </div>
        </div>
	    <div class="row cl">
