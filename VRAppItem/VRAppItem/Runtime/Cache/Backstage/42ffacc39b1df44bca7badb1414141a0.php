...
<body>
<div class="pd-20">
	<form action="/VRAppItem/index.php/Backstage/Class/classEdit" method="post" class="form form-horizontal" id="form-article-add">
        <input type="hidden" value="<?php echo ($class_info['c_id']); ?>" name=
        "id"/>
		<div class="row cl">
			<label class="form-label col-2">顶级分类标题：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="<?php echo ($class_info['c_title']); ?>"  id="imageatitle" name="title">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">顶级分类描述：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="<?php echo ($class_info['c_describe']); ?>" id="imageadescribe" name="describe">
			</div>
		</div>
		<div class="row cl">
