...
<body>
<div class="pd-20">
	<form action="/VRAppItem/index.php/Backstage/Lable/add" method="post" class="form form-horizontal" id="form-article-add">
        <input type="hidden" value="<?php echo ($info['id']); ?>" name=
        "fid"/>
        <input type="hidden" value="<?php echo ($info['path']); ?>" name="path"/>
		<div class="row cl">
			<label class="form-label col-2">顶级分类标题：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="" placeholder="请输入顶级分类标题" id="imageatitle" name="title">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">顶级分类描述：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="" placeholder="请输入顶级分类描述" id="imageadescribe" name="describe">
			</div>
		</div>
		<div class="row cl">
