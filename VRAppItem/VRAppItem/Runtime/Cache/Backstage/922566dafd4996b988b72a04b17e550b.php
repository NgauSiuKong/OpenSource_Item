...
<div class="pd-20">
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
                <?php if(is_array($list['selArr'])): foreach($list['selArr'] as $key=>$val): ?><!--
                ...
                -->
					...
					<td class="td-manage">
                        <?php if($val["v_status"] == 1): ?><a style="text-decoration:none" onClick='article_stop(this,"<?php echo ($val["v_id"]); ?>")' href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a>
                        <?php else: ?>
                            <a style="text-decoration:none" onClick='article_start(this,"<?php echo ($val["v_id"]); ?>")' href="javascript:;" title="发布"><i class="Hui-iconfont">&#xe603;</i></a><?php endif; ?>
    
                        <a class="ml-5" href="/index.php/Backstage/Video/editVideo?id=<?php echo ($val["v_id"]); ?>" title="编辑">
...
$('.table-sort').dataTable({
    ...
    function article_del(obj,id){
        layer.confirm('确认要删除到回收站吗？',function(index){
            $.ajax({ 
                url:'/index.php/Backstage/Video/delVideoRC',
                type:'post',
                dataType:'json',
                data:{id:id},
    ...
    function article_stop(obj,id){
        layer.confirm('确认要下架吗？',function(index){
            $.ajax({ 
                url:'/index.php/Backstage/Video/modStatus',
                type:'post',
                dataType:'json',
                data:{id:id},
                success:function(msg){ 
