...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 分类管理 <span class="c-gray en">&gt;</span>分类列表<span class="c-gray en">&gt;</span> <?php echo ($className); ?>下面资源<a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" href="/VRAppItem/index.php/Backstage/Class/addVidCla?id=<?php echo ($id); ?>"><i class="Hui-iconfont">&#xe600;</i> 添加资源</a></span> <span class="r">共有数据：<strong><?php echo ($list['count']); ?></strong> 条</span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
                <?php if(is_array($video_list)): foreach($video_list as $key=>$val): ?><tr class="text-c">
...
$('.table-sort').dataTable({
    ...
    function article_del(obj,id,videoName){
        layer.confirm('确认要删除吗？',function(index){
            $.ajax({ 
                url:'/VRAppItem/index.php/Backstage/Class/delVidCla',
                type:'post',
                dataType:'json',
                data:{id:id},
